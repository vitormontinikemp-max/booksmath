...
},
{
    ...
    language: "en",
    category: "foundations",
    description: "Advanced treatment of mathematical logic. This comprehensive text covers recursion theory, model theory, proof theory, and set theory with rigorous mathematical treatment.",
    rating: 4.6,
    pages: 878,
    year: 2005
},
{
    ...
    language: "en",
    category: "foundations",
    description: "Introduction to independence proofs in set theory. This book covers forcing, constructibility, and large cardinals, providing tools for proving independence results.",
    rating: 4.7,
    pages: 313,
    year: 1980
},
{
    ...
    author: "Steven Givant & Paul Halmos",
    language: "en",
    category: "foundations",
    description: "Comprehensive introduction to Boolean algebras. This book covers the algebraic theory of Boolean algebras with applications to logic and set theory.",
    rating: 4.5,
    pages: 574,
    year: 2009
},
{
    id: 364,
    title: "Fundamentos da Teoria dos Conjuntos",
    author: "Sérgio L. P. Silva",
    language: "pt",
    category: "foundations",
    description: "Introdução à teoria axiomática dos conjuntos. Este livro apresenta os axiomas ZFC e desenvolve a teoria dos conjuntos de forma rigorosa e acessível.",
    rating: 4.4,
    pages: 280,
    year: 2015
},
{
    id: 365,
    title: "Lógica Matemática para Computação",
    author: "João Nunes de Souza",
    language: "pt",
    category: "foundations",
    description: "Lógica aplicada à ciência da computação. Este livro aborda lógica proposicional, predicados e aplicações em verificação formal e inteligência artificial.",
    rating: 4.5,
    pages: 320,
    year: 2018
},
{
    ...
    language: "en",
    category: "advanced",
    description: "Geometric introduction to algebraic topology. This book emphasizes geometric intuition while covering fundamental groups, covering spaces, and homology.",
    rating: 4.7,
    pages: 430,
    year: 1995
},
{
    ...
    language: "en",
    category: "advanced",
    description: "Introduction to differential topology. This book covers manifolds, transversality, intersection theory, and differential forms with geometric insight.",
    rating: 4.8,
    pages: 222,
    year: 1974
},
{
    ...
    language: "en",
    category: "algebra",
    description: "Comprehensive introduction to homological algebra. This book covers derived functors, spectral sequences, and applications to algebra and topology.",
    rating: 4.6,
    pages: 450,
    year: 1994
},
{
    id: 369,
    title: "Teoria de Homotopia",
    author: "Carlos A. M. de Andrade",
    language: "pt",
    category: "advanced",
    description: "Introdução à teoria de homotopia. Este livro aborda grupos de homotopia, sequências exatas longas e teorema de Hurewicz.",
    rating: 4.5,
    pages: 300,
    year: 2012
},
{
    ...
    language: "pt",
    category: "advanced",
    description: "Introdução à topologia diferencial. Este livro aborda variedades diferenciáveis, teorema de Sard e grau de aplicações.",
    rating: 4.6,
    pages: 280,
    year: 2010
},
{
    ...
    language: "en",
    category: "algebra",
    description: "Advanced commutative algebra. This book covers dimension theory, depth, Cohen-Macaulay rings, and Gorenstein rings with applications to algebraic geometry.",
    rating: 4.7,
    pages: 320,
    year: 1989
},
{
    ...
    language: "en",
    category: "algebra",
    description: "Introduction to finite group representations. This book covers characters, orthogonality relations, and induced representations with numerous examples.",
    rating: 4.6,
    pages: 272,
    year: 2012
},
{
    id: 373,
    title: "Anéis Comutativos e Geometria Algébrica",
    author: "Aron Simis",
    language: "pt",
    category: "algebra",
    description: "Conexões entre álgebra comutativa e geometria algébrica. Este livro aborda ideais, módulos e suas interpretações geométricas.",
    rating: 4.5,
    pages: 350,
    year: 2014
},
{
    id: 374,
    title: "Teoria de Representações de Grupos Finitos",
    author: "A. Z. L. Figueiredo",
    language: "pt",
    category: "algebra",
    description: "Representações de grupos finitos. Este livro aborda caracteres, tabelas de caracteres e aplicações em física e química.",
    rating: 4.4,
    pages: 260,
    year: 2008
},
{
    ...
    language: "en",
    category: "algebra",
    description: "Integration of linear algebra and optimization. This book covers linear programming, convex optimization, and applications to operations research.",
    rating: 4.5,
    pages: 384,
    year: 2009
},
{
    ...
    language: "en",
    category: "algebra",
    description: "Comprehensive matrix theory. This book covers matrix decompositions, generalized inverses, and computational aspects of matrix algebra.",
    rating: 4.6,
    pages: 530,
    year: 2007
},
{
    ...
    language: "pt",
    category: "algebra",
    description: "Álgebra linear com métodos computacionais. Este livro aborda algoritmos para problemas de álgebra linear e suas implementações.",
    rating: 4.5,
    pages: 380,
    year: 2019
},
{
    ...
    language: "pt",
    category: "algebra",
    description: "Programação linear e aplicações. Este livro aborda método simplex, dualidade e aplicações em problemas de otimização.",
    rating: 4.6,
    pages: 320,
    year: 2012
},
{
    id: 379,
    title: "Real Analysis: A Comprehensive Course",
    author: "A. B. Kharazishvili",
    language: "en",
    category: "calculus",
    description: "Advanced real analysis topics. This book covers non-measurable sets, paradoxical decompositions, and other advanced topics in real analysis.",
    rating: 4.5,
    pages: 420,
    year: 2006
},
{
    ...
    language: "en",
    category: "calculus",
    description: "Introduction to Lebesgue integration. This book covers measure theory and Lebesgue integration with emphasis on Euclidean spaces.",
    rating: 4.6,
    pages: 588,
    year: 2001
},
{
    ...
    language: "en",
    category: "calculus",
    description: "Rigorous single-variable analysis. This book covers limits, continuity, differentiation, and integration with ε-δ proofs and applications.",
    rating: 4.5,
    pages: 384,
    year: 2016
},
{
    ...
    language: "pt",
    category: "calculus",
    description: "Teoria da medida e integração de Lebesgue. Este livro aborda espaços de medida, integração e teoremas de convergência.",
    rating: 4.5,
    pages: 300,
    year: 2013
},
{
    ...
    language: "pt",
    category: "calculus",
    description: "Cálculo em várias variáveis. Este livro aborda campos vetoriais, integrais de linha e de superfície, e teoremas de Green, Stokes e Gauss.",
    rating: 4.7,
    pages: 450,
    year: 2002
},
{
    id: 384,
    title: "Análise Complexa Avançada",
    author: "Elias M. Stein",
    language: "pt",
    category: "calculus",
    description: "Tradução da análise complexa avançada. Esta tradução aborda funções holomorfas, teorema dos resíduos e mapeamento conforme.",
    rating: 4.6,
    pages: 380,
    year: 2015
},
{
    ...
    language: "en",
    category: "geometry",
    description: "Comprehensive differential geometry. This book covers manifolds, tensors, connections, curvature, and Riemannian geometry.",
    rating: 4.8,
    pages: 624,
    year: 2019
},
{
    ...
    author: "Enrico Arbarello et al.",
    language: "en",
    category: "geometry",
    description: "Advanced algebraic curves. This two-volume work covers the modern theory of algebraic curves with emphasis on moduli spaces.",
    rating: 4.7,
    pages: 965,
    year: 1985
},
{
    ...
    language: "en",
    category: "geometry",
    description: "Classic work on convex polytopes. This book covers combinatorial and geometric properties of convex polytopes in all dimensions.",
    rating: 4.6,
    pages: 456,
    year: 2003
},
{
    ...
    language: "pt",
    category: "geometry",
    description: "Introdução à geometria Riemanniana. Este livro aborda conexões Riemannianas, curvatura e geodésicas.",
    rating: 4.7,
    pages: 320,
    year: 2012
},
{
    id: 389,
    title: "Geometria Algébrica para Iniciantes",
    author: "Aron Simis",
    language: "pt",
    category: "geometry",
    description: "Introdução à geometria algébrica. Este livro aborda variedades afins e projetivas, com exemplos concretos e aplicações.",
    rating: 4.5,
    pages: 280,
    year: 2016
},
{
    id: 390,
    title: "Geometria de Polígonos",
    author: "Eduardo Wagner",
    language: "pt",
    category: "geometry",
    description: "Propriedades geométricas de polígonos. Este livro aborda polígonos convexos, áreas, e problemas olímpicos relacionados.",
    rating: 4.6,
    pages: 240,
    year: 2014
},
{
    ...
    language: "en",
    category: "combinatorics",
    description: "Advanced enumerative techniques. This book covers generating functions, inclusion-exclusion, and advanced counting methods.",
    rating: 4.6,
    pages: 609,
    year: 2002
},
{
    ...
    language: "en",
    category: "combinatorics",
    description: "Comprehensive graph theory applications. This book covers graph algorithms, planarity, coloring, and applications to computer science.",
    rating: 4.7,
    pages: 800,
    year: 2005
},
{
    ...
    language: "en",
    category: "combinatorics",
    description: "Introduction to design theory. This book covers Latin squares, block designs, and finite geometries with constructions and applications.",
    rating: 4.5,
    pages: 372,
    year: 2007
},
{
    id: 394,
    title: "Teoria dos Grafos Aplicada",
    author: "Cláudia L. de Oliveira",
    language: "pt",
    category: "combinatorics",
    description: "Aplicações práticas da teoria dos grafos. Este livro aborda algoritmos em grafos com implementações e estudos de caso.",
    rating: 4.6,
    pages: 350,
    year: 2015
},
{
    id: 395,
    title: "Combinatória Analítica",
    author: "H. P. Bueno",
    language: "pt",
    category: "combinatorics",
    description: "Métodos analíticos em combinatória. Este livro aborda funções geradoras, assintóticas e análise de algoritmos combinatórios.",
    rating: 4.5,
    pages: 320,
    year: 2018
},
{
    ...
    language: "pt",
    category: "combinatorics",
    description: "Problemas resolvidos de teoria dos grafos. Este livro apresenta problemas desafiadores com soluções detalhadas.",
    rating: 4.6,
    pages: 280,
    year: 2013
},
{
    ...
    author: "P. T. Bateman & H. G. Diamond",
    language: "en",
    category: "number-theory",
    description: "Accessible analytic number theory. This book introduces analytic methods with emphasis on prime number theory and Dirichlet series.",
    rating: 4.6,
    pages: 320,
    year: 2004
},
{
    ...
    language: "en",
    category: "number-theory",
    description: "Comprehensive elementary number theory. This book covers divisibility, congruences, quadratic reciprocity, and Diophantine equations.",
    rating: 4.5,
    pages: 430,
    year: 2005
},
{
    ...
    language: "en",
    category: "number-theory",
    description: "Applications of number theory to cryptography. This book covers RSA, elliptic curve cryptography, and primality testing.",
    rating: 4.6,
    pages: 384,
    year: 2002
},
{
    id: 400,
    title: "Teoria Analítica dos Números",
    author: "S. C. Coutinho",
    language: "pt",
    category: "number-theory",
    description: "Introdução à teoria analítica dos números. Este livro aborda funções aritméticas, séries de Dirichlet e o teorema dos números primos.",
    rating: 4.5,
    pages: 260,
    year: 2014
},
{
    id: 401,
    title: "Números Algébricos",
    author: "Abramo Hefez",
    language: "pt",
    category: "number-theory",
    description: "Introdução à teoria dos números algébricos. Este livro aborda corpos numéricos, inteiros algébricos e teoria de ideais.",
    rating: 4.6,
    pages: 320,
    year: 2010
},
{
    id: 402,
    title: "Aplicações da Teoria dos Números",
    author: "Plácido Z. Táboas",
    language: "pt",
    category: "number-theory",
    description: "Aplicações práticas da teoria dos números. Este livro aborda criptografia, códigos corretores de erros e outras aplicações.",
    rating: 4.5,
    pages: 280,
    year: 2016
},
{
    ...
    language: "en",
    category: "probability",
    description: "Bayesian probability theory. This influential book presents probability as an extension of logic, with applications to scientific inference.",
    rating: 4.8,
    pages: 727,
    year: 2003
},
{
    ...
    language: "en",
    category: "probability",
    description: "Stochastic calculus applications in finance. This two-volume set covers Brownian motion, stochastic integration, and option pricing.",
    rating: 4.7,
    pages: 550,
    year: 2004
},
{
    ...
    language: "en",
    category: "probability",
    description: "Comprehensive time series analysis. This book covers ARMA models, spectral analysis, and multivariate time series methods.",
    rating: 4.8,
    pages: 820,
    year: 1994
},
{
    id: 406,
    title: "Probabilidade Bayesian",
    author: "M. A. R. Ferreira",
    language: "pt",
    category: "probability",
    description: "Introdução à probabilidade bayesiana. Este livro aborda inferência bayesiana, métodos computacionais e aplicações.",
    rating: 4.6,
    pages: 350,
    year: 2015
},
{
    ...
    language: "pt",
    category: "probability",
    description: "Análise de séries temporais. Este livro aborda modelos ARIMA, previsão e análise espectral com implementações em R.",
    rating: 4.7,
    pages: 380,
    year: 2018
},
{
    id: 408,
    title: "Processos Estocásticos Aplicados",
    author: "Paulo R. C. Ruffino",
    language: "pt",
    category: "probability",
    description: "Aplicações de processos estocásticos. Este livro aborda cadeias de Markov, processos de Poisson e aplicações em finanças e biologia.",
    rating: 4.6,
    pages: 320,
    year: 2014
},
{
    ...
    language: "en",
    category: "advanced",
    description: "Applied PDEs with Fourier methods. This book covers separation of variables, Fourier series, and boundary value problems with applications.",
    rating: 4.7,
    pages: 803,
    year: 2004
},
{
    ...
    language: "en",
    category: "advanced",
    description: "Classic complex variables textbook. This book covers analytic functions, contour integration, and conformal mapping with engineering applications.",
    rating: 4.7,
    pages: 480,
    year: 2014
},
{
    ...
    language: "en",
    category: "advanced",
    description: "Comprehensive mathematical methods. This book covers vector calculus, PDEs, complex variables, and group theory for physics and engineering.",
    rating: 4.8,
    pages: 1332,
    year: 2006
},
{
    ...
    language: "pt",
    category: "advanced",
    description: "Teoria qualitativa de EDOs. Este livro aborda sistemas lineares, estabilidade e teorema de Poincaré-Bendixson.",
    rating: 4.7,
    pages: 420,
    year: 2008
},
{
    ...
    language: "pt",
    category: "advanced",
    description: "Tradução dos métodos matemáticos para engenharia. Esta tradução abrange equações diferenciais, análise complexa e transformadas integrais.",
    rating: 4.8,
    pages: 1100,
    year: 2009
},
{
    id: 414,
    title: "Análise de Fourier e Aplicações",
    author: "Djairo G. de Figueiredo",
    language: "pt",
    category: "advanced",
    description: "Transformadas de Fourier e aplicações. Este livro aborda séries de Fourier, transformada de Fourier e aplicações em EDPs.",
    rating: 4.7,
    pages: 380,
    year: 2011
},
{
    ...
    language: "en",
    category: "computational",
    description: "Classic algorithms textbook. This book covers algorithm design techniques, complexity analysis, and NP-completeness theory.",
    rating: 4.7,
    pages: 470,
    year: 1974
},
{
    ...
    author: "Mark de Berg et al.",
    language: "en",
    category: "computational",
    description: "Algorithms for geometric problems. This book covers convex hulls, Voronoi diagrams, and other computational geometry topics.",
    rating: 4.8,
    pages: 370,
    year: 2008
},
{
    ...
    language: "en",
    category: "computational",
    description: "Classic numerical methods text. This book covers interpolation, integration, differential equations, and error analysis.",
    rating: 4.7,
    pages: 721,
    year: 1973
},
{
    ...
    language: "pt",
    category: "computational",
    description: "Tradução do livro de algoritmos. Esta tradução mantém a abordagem abrangente e rigorosa do original, com muitos exemplos.",
    rating: 4.8,
    pages: 1350,
    year: 2012
},
{
    ...
    language: "pt",
    category: "computational",
    description: "Fundamentos de geometria computacional. Este livro aborda algoritmos geométricos, complexidade e implementações.",
    rating: 4.7,
    pages: 420,
    year: 2011
},
{
    id: 420,
    title: "Métodos Numéricos Avançados",
    author: "M. A. G. Ruggiero",
    language: "pt",
    category: "computational",
    description: "Métodos numéricos avançados. Este livro aborda elementos finitos, diferenças finitas e métodos espectrais.",
    rating: 4.6,
    pages: 480,
    year: 2008
},
{
    id: 421,
    title: "International Mathematical Olympiad: 1959-1999",
    author: "István Reiman",
    language: "en",
    category: "olympiads",
    description: "Collection of early IMO problems. This book compiles problems from the first 40 years of the IMO with solutions and historical notes.",
    rating: 4.7,
    pages: 392,
    year: 2001
},
{
    id: 422,
    title: "Mathematical Olympiad in China",
    author: "Bin Xiong & Peng Yee Lee",
    language: "en",
    category: "olympiads",
    description: "Chinese mathematical olympiad problems. This book presents problems from Chinese competitions with unique solution techniques.",
    rating: 4.6,
    pages: 276,
    year: 2007
},
{
    ...
    language: "en",
    category: "olympiads",
    description: "Problem-driven combinatorics. This collection helps develop combinatorial reasoning through carefully graded problems.",
    rating: 4.7,
    pages: 636,
    year: 1993
},
{
    id: 424,
    title: "Olimpíadas de Matemática: Problemas Selecionados",
    author: "E. Carneiro",
    language: "pt",
    category: "olympiads",
    description: "Seleção de problemas olímpicos. Este livro reúne problemas desafiadores de várias competições, com soluções detalhadas.",
    rating: 4.7,
    pages: 350,
    year: 2018
},
{
    id: 425,
    title: "Treinamento Avançado para Olimpíadas",
    author: "A. C. M. Neto",
    language: "pt",
    category: "olympiads",
    description: "Material de treinamento avançado. Este livro aborda técnicas sofisticadas e problemas de alto nível para competições internacionais.",
    rating: 4.8,
    pages: 420,
    year: 2020
},
{
    id: 426,
    title: "Problemas de Olimpíadas Internacionais",
    author: "SBM",
    language: "pt",
    category: "olympiads",
    description: "Tradução de problemas de olimpíadas internacionais. Este livro apresenta problemas de IMO, Putnam e outras competições.",
    rating: 4.7,
    pages: 480,
    year: 2017
},
{
    ...
    language: "en",
    category: "foundations",
    description: "Modern introduction to category theory. This book presents categories, functors, natural transformations, and limits with numerous examples.",
    rating: 4.7,
    pages: 328,
    year: 2010
},
{
    ...
    language: "en",
    category: "foundations",
    description: "Classic model theory textbook. This book covers ultraproducts, completeness theorems, and stability theory.",
    rating: 4.6,
    pages: 650,
    year: 1990
},
{
    id: 429,
    title: "Teoria de Categorias",
    author: "M. P. do Carmo",
    language: "pt",
    category: "foundations",
    description: "Introdução à teoria de categorias. Este livro aborda categorias, funtores e transformações naturais com exemplos concretos.",
    rating: 4.5,
    pages: 280,
    year: 2015
},
{
    ...
    language: "pt",
    category: "foundations",
    description: "Lógica de primeira ordem completa. Este livro aborda sintaxe, semântica, completude e aplicações da lógica de primeira ordem.",
    rating: 4.4,
    pages: 320,
    year: 2012
},
{
    ...
    language: "en",
    category: "algebra",
    description: "Introduction to Lie theory. This book covers matrix Lie groups, Lie algebras, and their representations with physical applications.",
    rating: 4.6,
    pages: 228,
    year: 1984
},
{
    ...
    language: "en",
    category: "algebra",
    description: "Introduction to algebraic groups. This book covers linear algebraic groups, Lie algebras, and representation theory.",
    rating: 4.7,
    pages: 119,
    year: 1975
},
{
    ...
    language: "pt",
    category: "algebra",
    description: "Introdução aos grupos de Lie. Este livro aborda grupos de matrizes, álgebras de Lie e representações.",
    rating: 4.5,
    pages: 300,
    year: 2011
},
{
    ...
    language: "pt",
    category: "algebra",
    description: "Introdução à álgebra homológica. Este livro aborda sequências exatas, funtores derivados e resoluções.",
    rating: 4.4,
    pages: 280,
    year: 2016
},
{
    ...
    language: "en",
    category: "algebra",
    description: "Geometric approach to linear algebra. This book emphasizes visual understanding of vector spaces, transformations, and eigenvalues.",
    rating: 4.6,
    pages: 272,
    year: 1992
},
{
    ...
    language: "en",
    category: "algebra",
    description: "Advanced matrix theory. This book covers topics like matrix inequalities, perturbation theory, and numerical range.",
    rating: 4.5,
    pages: 285,
    year: 1990
},
{
    id: 437,
    title: "Álgebra Linear Geométrica",
    author: "Luiz Francisco da S. Ramos",
    language: "pt",
    category: "algebra",
    description: "Abordagem geométrica da álgebra linear. Este livro enfatiza a intuição geométrica por trás dos conceitos algébricos.",
    rating: 4.5,
    pages: 320,
    year: 2013
},
{
    ...
    language: "pt",
    category: "algebra",
    description: "Teoria de matrizes especiais. Este livro aborda matrizes positivas, estocásticas, e outras classes especiais de matrizes.",
    rating: 4.4,
    pages: 260,
    year: 2014
},
{
    ...
    language: "en",
    category: "calculus",
    description: "Multivariable calculus. This book covers differentiation and integration in multiple dimensions with rigorous proofs.",
    rating: 4.6,
    pages: 375,
    year: 1987
},
{
    ...
    language: "en",
    category: "calculus",
    description: "Engaging introduction to Fourier analysis. This book covers Fourier series and transforms with applications and historical notes.",
    rating: 4.7,
    pages: 591,
    year: 1988
},
{
    ...
    language: "pt",
    category: "calculus",
    description: "Cálculo multivariável completo. Este livro aborda funções de várias variáveis, integrais múltiplas e teoremas integrais.",
    rating: 4.7,
    pages: 520,
    year: 2002
},
{
    ...
    language: "pt",
    category: "calculus",
    description: "Teoria de séries e sequências. Este livro aborda convergência, séries de potências e séries de Fourier.",
    rating: 4.6,
    pages: 280,
    year: 2005
},
{
    ...
    language: "en",
    category: "geometry",
    description: "Introduction to hyperbolic geometry. This book covers models of hyperbolic space, isometries, and hyperbolic trigonometry.",
    rating: 4.6,
    pages: 276,
    year: 2005
},
{
    ...
    language: "en",
    category: "geometry",
    description: "Introduction to tropical geometry. This book covers tropical algebra, tropical varieties, and applications to algebraic geometry.",
    rating: 4.5,
    pages: 220,
    year: 2015
},
{
    id: 445,
    title: "Geometria de Incidência",
    author: "Carlos A. S. L. de Almeida",
    language: "pt",
    category: "geometry",
    description: "Geometria baseada em axiomas de incidência. Este livro aborda planos projetivos e afins, e suas propriedades combinatórias.",
    rating: 4.4,
    pages: 240,
    year: 2010
},
{
    ...
    language: "pt",
    category: "geometry",
    description: "Introdução às geometrias não-euclidianas. Este livro aborda geometria hiperbólica e elíptica com modelos concretos.",
    rating: 4.5,
    pages: 260,
    year: 2013
},
{
    ...
    language: "en",
    category: "combinatorics",
    description: "Advanced extremal combinatorics. This book covers Ramsey theory, extremal graph theory, and the probabilistic method.",
    rating: 4.6,
    pages: 412,
    year: 2011
},
{
    ...
    language: "en",
    category: "combinatorics",
    description: "Combinatorics with algebraic methods. This book covers symmetric functions, Young tableaux, and combinatorial species.",
    rating: 4.7,
    pages: 223,
    year: 1999
},
{
    id: 449,
    title: "Combinatória Extremal",
    author: "S. B. Feitosa",
    language: "pt",
    category: "combinatorics",
    description: "Introdução à combinatória extremal. Este livro aborda teorema de Ramsey, método probabilístico e problemas extremais.",
    rating: 4.5,
    pages: 280,
    year: 2019
},
{
    id: 450,
    title: "Grafos Extremais",
    author: "Célia Picinin de Mello",
    language: "pt",
    category: "combinatorics",
    description: "Teoria extremal de grafos. Este livro aborda números de Turán, grafos livres de triângulos e outros problemas extremais.",
    rating: 4.4,
    pages: 240,
    year: 2016
},
{
    ...
    language: "en",
    category: "number-theory",
    description: "Comprehensive elliptic curves. This book covers the arithmetic and geometry of elliptic curves with applications to cryptography.",
    rating: 4.7,
    pages: 539,
    year: 1992
},
{
    ...
    language: "en",
    category: "number-theory",
    description: "Introduction to p-adic numbers. This book covers p-adic analysis, p-adic integration, and applications to number theory.",
    rating: 4.6,
    pages: 298,
    year: 1997
},
{
    ...
    language: "pt",
    category: "number-theory",
    description: "Tradução de curvas elípticas. Esta tradução aborda a teoria aritmética e geométrica das curvas elípticas.",
    rating: 4.6,
    pages: 380,
    year: 2011
},
{
    ...
    language: "pt",
    category: "number-theory",
    description: "Introdução aos números p-ádicos. Este livro aborda análise p-ádica e aplicações em teoria dos números.",
    rating: 4.5,
    pages: 260,
    year: 1999
},
{
    ...
    language: "en",
    category: "probability",
    description: "Graduate-level stochastic calculus. This book covers Brownian motion, stochastic integration, and applications to finance.",
    rating: 4.8,
    pages: 470,
    year: 1991
},
{
    ...
    language: "en",
    category: "probability",
    description: "Probability theory on graphs. This book covers percolation, random walks, and interacting particle systems.",
    rating: 4.7,
    pages: 258,
    year: 2010
},
{
    ...
    language: "pt",
    category: "probability",
    description: "Introdução ao cálculo estocástico. Este livro aborda movimento browniano, integração estocástica e fórmula de Itô.",
    rating: 4.6,
    pages: 300,
    year: 2016
},
{
    id: 458,
    title: "Probabilidade em Grafos",
    author: "Cláudia L. de Oliveira",
    language: "pt",
    category: "probability",
    description: "Processos probabilísticos em grafos. Este livro aborda passeios aleatórios, percolação e modelos de redes.",
    rating: 4.5,
    pages: 280,
    year: 2018
},
{
    ...
    language: "en",
    category: "advanced",
    description: "Introduction to dynamical systems. This book covers bifurcations, chaos, fractals, and applications to science and engineering.",
    rating: 4.8,
    pages: 513,
    year: 2014
},
{
    ...
    language: "en",
    category: "advanced",
    description: "Introduction to control theory. This book covers controllability, observability, stability, and optimal control.",
    rating: 4.7,
    pages: 496,
    year: 1998
},
{
    id: 461,
    title: "Dinâmica Não-Linear",
    author: "Jacob Palis",
    language: "pt",
    category: "advanced",
    description: "Introdução à dinâmica não-linear. Este livro aborda bifurcações, caos e atratores estranhos.",
    rating: 4.6,
    pages: 320,
    year: 2007
},
{
    ...
    language: "pt",
    category: "advanced",
    description: "Introdução à teoria de controle. Este livro aborda controlabilidade, observabilidade e controle ótimo.",
    rating: 4.5,
    pages: 300,
    year: 2014
},
{
    ...
    language: "en",
    category: "computational",
    description: "Design of parallel algorithms. This book covers parallel architectures, algorithm design, and complexity analysis.",
    rating: 4.6,
    pages: 446,
    year: 1994
},
{
    ...
    language: "en",
    category: "computational",
    description: "Introduction to quantum algorithms. This book covers quantum Fourier transform, Grover's algorithm, and quantum error correction.",
    rating: 4.7,
    pages: 320,
    year: 2008
},
{
    ...
    language: "pt",
    category: "computational",
    description: "Projeto de algoritmos paralelos. Este livro aborda arquiteturas paralelas, complexidade e implementação de algoritmos paralelos.",
    rating: 4.5,
    pages: 350,
    year: 2017
},
{
    ...
    language: "pt",
    category: "computational",
    description: "Tradução da computação quântica. Esta tradução aborda algoritmos quânticos, informação quântica e correção de erros.",
    rating: 4.8,
    pages: 700,
    year: 2013
},
{
    id: 467,
    title: "USAMO Problems and Solutions",
    author: "Titu Andreescu & Zuming Feng",
    language: "en",
    category: "olympiads",
    description: "USA Mathematical Olympiad problems. This book compiles USAMO problems with solutions and training materials.",
    rating: 4.7,
    pages: 282,
    year: 2006
},
{
    id: 468,
    title: "IMO Training Materials",
    author: "Titu Andreescu et al.",
    language: "en",
    category: "olympiads",
    description: "Comprehensive IMO training. This set of books provides extensive problem sets and theory for IMO preparation.",
    rating: 4.8,
    pages: 1200,
    year: 2010
},
{
    id: 469,
    title: "Problemas da OBMEP",
    author: "IMPA",
    language: "pt",
    category: "olympiads",
    description: "Problemas da Olimpíada Brasileira de Matemática das Escolas Públicas. Esta coleção reúne problemas das primeiras fases com soluções.",
    rating: 4.7,
    pages: 420,
    year: 2019
},
{
    id: 470,
    title: "Preparação para a Olimpíada Internacional",
    author: "SBM",
    language: "pt",
    category: "olympiads",
    description: "Material avançado para preparação da IMO. Este livro aborda técnicas específicas e problemas de alto nível.",
    rating: 4.8,
    pages: 480,
    year: 2021
},
{
    ...
    language: "en",
    category: "foundations",
    description: "Classical recursion theory. This book covers computable functions, Turing degrees, and priority arguments.",
    rating: 4.6,
    pages: 437,
    year: 1987
},
{
    id: 472,
    title: "Teoria da Recursão",
    author: "Sérgio L. P. Silva",
    language: "pt",
    category: "foundations",
    description: "Introdução à teoria da recursão. Este livro aborda funções recursivas, máquinas de Turing e problemas de decisão.",
    rating: 4.4,
    pages: 280,
    year: 2017
},
{
    ...
    author: "M. D. Larsen & P. J. McCarthy",
    language: "en",
    category: "algebra",
    description: "Introduction to noncommutative algebra. This book covers division algebras, semisimple rings, and representation theory.",
    rating: 4.5,
    pages: 309,
    year: 1971
},
{
    id: 474,
    title: "Álgebra Não-Comutativa",
    author: "A. Z. L. Figueiredo",
    language: "pt",
    category: "algebra",
    description: "Introdução à álgebra não-comutativa. Este livro aborda anéis simples, módulos e teoria de representações.",
    rating: 4.4,
    pages: 260,
    year: 2013
},
{
    ...
    language: "en",
    category: "calculus",
    description: "Classic integral equations text. This book covers Fredholm and Volterra equations with applications to physics.",
    rating: 4.6,
    pages: 238,
    year: 1985
},
{
    id: 476,
    title: "Equações Integrais",
    author: "Djairo G. de Figueiredo",
    language: "pt",
    category: "calculus",
    description: "Introdução às equações integrais. Este livro aborda equações de Fredholm e Volterra, e aplicações.",
    rating: 4.5,
    pages: 240,
    year: 2009
},
{
    ...
    author: "Alexander I. Bobenko et al.",
    language: "en",
    category: "geometry",
    description: "Discrete geometric structures. This book covers discrete surfaces, curvature, and integrable systems.",
    rating: 4.6,
    pages: 341,
    year: 2008
},
{
    id: 478,
    title: "Geometria Diferencial Discreta",
    author: "Jonas Gomes",
    language: "pt",
    category: "geometry",
    description: "Geometria diferencial para superfícies discretas. Este livro aborda malhas, curvatura discreta e aplicações em computação gráfica.",
    rating: 4.5,
    pages: 280,
    year: 2015
},
{
    ...
    language: "en",
    category: "combinatorics",
    description: "Comprehensive probabilistic method. This book covers the use of probability in proving combinatorial existence results.",
    rating: 4.8,
    pages: 375,
    year: 2016
},
{
    id: 480,
    title: "Método Probabilístico",
    author: "S. B. Feitosa",
    language: "pt",
    category: "combinatorics",
    description: "Aplicação do método probabilístico. Este livro aborda o uso de probabilidade em problemas existenciais de combinatória.",
    rating: 4.6,
    pages: 240,
    year: 2020
},
{
    ...
    language: "en",
    category: "number-theory",
    description: "Introduction to additive number theory. This book covers sumsets, Schnirelmann density, and the Goldbach conjecture.",
    rating: 4.6,
    pages: 342,
    year: 1996
},
{
    id: 482,
    title: "Teoria Aditiva dos Números",
    author: "Plácido Z. Táboas",
    language: "pt",
    category: "number-theory",
    description: "Introdução à teoria aditiva dos números. Este livro aborda somas de conjuntos e problemas como a conjectura de Goldbach.",
    rating: 4.5,
    pages: 260,
    year: 2017
},
{
    ...
    language: "en",
    category: "probability",
    description: "Comprehensive information theory. This book covers entropy, channel capacity, and coding theorems.",
    rating: 4.8,
    pages: 776,
    year: 2006
},
{
    ...
    language: "pt",
    category: "probability",
    description: "Introdução à teoria da informação. Este livro aborda entropia, capacidade de canal e codificação.",
    rating: 4.6,
    pages: 320,
    year: 2016
},
{
    ...
    language: "en",
    category: "advanced",
    description: "Mathematical methods in physics. This book covers classical mechanics, symplectic geometry, and integrable systems.",
    rating: 4.8,
    pages: 816,
    year: 1989
},
{
    ...
    language: "pt",
    category: "advanced",
    description: "Métodos matemáticos para física. Este livro aborda equações diferenciais, análise complexa e grupos de Lie para física.",
    rating: 4.7,
    pages: 680,
    year: 2008
},
{
    ...
    language: "en",
    category: "computational",
    description: "Modern complexity theory. This book covers circuit complexity, interactive proofs, and quantum complexity.",
    rating: 4.8,
    pages: 579,
    year: 2009
},
{
    ...
    language: "pt",
    category: "computational",
    description: "Introdução à teoria da complexidade. Este livro aborda classes de complexidade, NP-completude e algoritmos aproximados.",
    rating: 4.7,
    pages: 350,
    year: 2018
},
{
    id: 489,
    title: "Geometry for Olympiads",
    author: "Zuming Feng",
    language: "en",
    category: "olympiads",
    description: "Comprehensive geometry for competitions. This book covers advanced geometric techniques for mathematical olympiads.",
    rating: 4.7,
    pages: 320,
    year: 2008
},
{
    id: 490,
    title: "Álgebra para Competições",
    author: "E. Carneiro",
    language: "pt",
    category: "olympiads",
    description: "Álgebra avançada para olimpíadas. Este livro aborda polinômios, desigualdades e equações funcionais para competições.",
    rating: 4.7,
    pages: 380,
    year: 2019
},
{
    ...
    language: "en",
    category: "foundations",
    description: "Introduction to proof theory. This book covers cut-elimination, ordinal analysis, and consistency proofs.",
    rating: 4.6,
    pages: 372,
    year: 1987
},
{
    id: 492,
    title: "Teoria da Prova",
    author: "Edgar Almeida Rodrigues",
    language: "pt",
    category: "foundations",
    description: "Introdução à teoria da prova. Este livro aborda sistemas formais, teoremas de completude e incompletude.",
    rating: 4.4,
    pages: 280,
    year: 2014
},
{
    ...
    language: "en",
    category: "algebra",
    description: "Comprehensive universal algebra. This book covers lattices, varieties, and free algebras with applications.",
    rating: 4.6,
    pages: 381,
    year: 2008
},
{
    id: 494,
    title: "Álgebra Universal",
    author: "A. Z. L. Figueiredo",
    language: "pt",
    category: "algebra",
    description: "Introdução à álgebra universal. Este livro aborda reticulados, variedades e álgebras livres.",
    rating: 4.4,
    pages: 260,
    year: 2012
},
{
    ...
    language: "en",
    category: "calculus",
    description: "Introduction to asymptotic methods. This book covers asymptotic expansions, Laplace's method, and WKB approximation.",
    rating: 4.6,
    pages: 160,
    year: 1984
},
{
    ...
    language: "pt",
    category: "calculus",
    description: "Introdução aos métodos assintóticos. Este livro aborda expansões assintóticas e aplicações em equações diferenciais.",
    rating: 4.5,
    pages: 240,
    year: 2017
},
{
    ...
    language: "en",
    category: "geometry",
    description: "Introduction to symplectic geometry. This book covers symplectic manifolds, Hamiltonian mechanics, and moment maps.",
    rating: 4.7,
    pages: 266,
    year: 2001
},
{
    id: 498,
    title: "Geometria Simplética",
    author: "M. P. do Carmo",
    language: "pt",
    category: "geometry",
    description: "Introdução à geometria simplética. Este livro aborda variedades simpléticas, mecânica hamiltoniana e aplicações.",
    rating: 4.6,
    pages: 280,
    year: 2014
},
{
    ...
    language: "en",
    category: "combinatorics",
    description: "Algebraic methods in graph theory. This book covers eigenvalues, strongly regular graphs, and association schemes.",
    rating: 4.7,
    pages: 439,
    year: 2001
},
{
    id: 500,
    title: "Teoria Algébrica dos Grafos",
    author: "Célia Picinin de Mello",
    language: "pt",
    category: "combinatorics",
    description: "Métodos algébricos em teoria dos grafos. Este livro aborda autovalores, grafos fortemente regulares e esquemas de associação.",
    rating: 4.5,
    pages: 300,
    year: 2018
}
